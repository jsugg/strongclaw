...
7. [`platform/docs/POLICY_ENGINE_AND_WRAPPERS.md`](platform/docs/POLICY_ENGINE_AND_WRAPPERS.md)
8. [`platform/docs/SECRETS_AND_ENV.md`](platform/docs/SECRETS_AND_ENV.md)
9. [`platform/docs/SECURITY_MODEL.md`](platform/docs/SECURITY_MODEL.md)
10. [`platform/docs/DEVFLOW.md`](platform/docs/DEVFLOW.md)
11. [`platform/docs/PLUGIN_INVENTORY.md`](platform/docs/PLUGIN_INVENTORY.md)
12. [`platform/docs/DEGRADATION.md`](platform/docs/DEGRADATION.md)
