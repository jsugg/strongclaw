      ...
      async execute(_toolCallId, params) {
        ...
        try {
          ...
          const skillContent = [
            ...
            "",
            "## When To Use",
            "- When this learning captures a recurring failure mode worth codifying.",
            "- When operators need deterministic steps instead of ad-hoc recovery.",
            "",
            "## Steps",
            "1. Confirm prerequisites and scope from the source learning before acting.",
            "2. Execute the remediation workflow as ordered, copy-pastable commands.",
            "3. Capture verification evidence and expected outputs for each step.",
            "",
            "## Source Learning",
