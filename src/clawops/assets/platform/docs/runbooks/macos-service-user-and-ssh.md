...
Create a dedicated standard user for the OpenClaw runtime and keep it separate from your daily admin account.
...
You can then manage the runtime with: `ssh openclawsvc@localhost`
