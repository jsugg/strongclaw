...
def test_strongclaw_baseline_infers_repo_root_and_runs_dir_from_cwd(
    ...
    recorded_exclude_browser_lab: bool | None = None
    ...
    def _verify_baseline(
        ...
        *,
        ...
        nonlocal recorded_repo_root, recorded_runs_dir, recorded_degraded, recorded_exclude_browser_lab
        recorded_repo_root = repo_root_arg
        recorded_runs_dir = runs_dir
        recorded_degraded = degraded
        recorded_exclude_browser_lab = exclude_browser_lab
    ...
    assert recorded_exclude_browser_lab is False
