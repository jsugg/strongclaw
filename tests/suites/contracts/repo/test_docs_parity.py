...
def test_browser_lab_docs_surface_first_class_verification_commands() -> None:
    ...
    assert "clawops baseline verify --exclude-browser-lab" in browser_lab
    assert "clawops baseline verify --include-browser-lab" not in browser_lab
    assert "not excluded from baseline verification by default" in browser_lab
