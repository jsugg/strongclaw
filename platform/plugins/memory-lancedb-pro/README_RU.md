...
<details> <summary><strong>Дополнительные варианты установки (для действующих пользователей и апгрейдов)</strong></summary>
...
<details> <summary><strong>Быстрый импорт для Telegram Bot (нажмите, чтобы раскрыть)</strong></summary>
...
<details> <summary><strong>Справочник по файлам (нажмите, чтобы раскрыть)</strong></summary>
...
<details> <summary><strong>Сравнение со встроенным <code>memory-lancedb</code> (нажмите, чтобы раскрыть)</strong></summary>
...
<details> <summary><strong>Полный пример конфигурации</strong></summary>
...
<details> <summary><strong>Провайдеры эмбеддингов</strong></summary>
...
<details> <summary><strong>Провайдеры реранжирования</strong></summary>
...
<details> <summary><strong>Конфигурация жизненного цикла (Decay + Tier)</strong></summary>
...
<details> <summary><strong>Усиление за счет доступа</strong></summary>
...
<details> <summary><strong>Если внедренные воспоминания попадают в ответы</strong></summary>
...
<details> <summary><strong>Память сессии</strong></summary>
...
<details> <summary><strong>Пользовательские slash-команды (например, /lesson)</strong></summary>
...
<details> <summary><strong>Железные правила для ИИ-агентов</strong></summary>
...
<details> <summary><strong>Схема базы данных</strong></summary>
...
<details> <summary><strong>Устранение неполадок</strong></summary>
